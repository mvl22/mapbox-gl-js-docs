...
This example uses the [mapbox-gl-geocoder](https://github.com/mapbox/mapbox-gl-geocoder) control to enable users to search for places using the [Mapbox Geocoding API](https://docs.mapbox.com/api/search/geocoding/), and accept geographic [coordinates](https://docs.mapbox.com/help/glossary/lat-long) in the search query.
