...
This example is like the [Display a map on a webpage](/mapbox-gl-js/example/simple-map/) example, but it uses the [style URL](https://docs.mapbox.com/help/glossary/style/#style-urls) for the [Mapbox Satellite](https://www.mapbox.com/maps/satellite/) style.
