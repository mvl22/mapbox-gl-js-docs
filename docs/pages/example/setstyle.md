...
When the user clicks a style name, it uses [`setstyle`](/mapbox-gl-js/api/map/#map#setstyle) to redraw the map using the [style URL](https://docs.mapbox.com/help/glossary/style/#style-urls) associated with that option.
