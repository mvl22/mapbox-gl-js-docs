...
It uses the [mapbox-gl-geocoder](https://github.com/mapbox/mapbox-gl-geocoder) control, which enables places search using the [Mapbox Geocoding API](https://docs.mapbox.com/api/search/geocoding/).
