...
Use the [mapbox-gl-geocoder](https://github.com/mapbox/mapbox-gl-geocoder) control plugin to search for places using [Mapbox Geocoding API](https://docs.mapbox.com/api/search/geocoding/) attached to an element outside the map.
